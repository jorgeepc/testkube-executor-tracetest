...
import (
	...
	"github.com/jorgeepc/testkube-executor-tracetest/pkg/command"
	"github.com/jorgeepc/testkube-executor-tracetest/pkg/model"
...
func getTracetestEndpointFromVars(envManager *secret.EnvManager) (string, error) {
	v, ok := envManager.Variables["TRACETEST_ENDPOINT"]
	if !ok {
